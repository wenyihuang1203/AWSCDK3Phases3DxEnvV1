...
export class SaocCommentStack extends Stack {
	constructor(scope: App, id: string, props: SaocCommentStackProps) {
		...
		Tags.of(SaocCommentInstance).add('Stage', 'Build');
		Tags.of(SaocCommentInstance).add('Platform', '3DExperience R2022x');
		Tags.of(SaocCommentInstance).add('Service', '3DComment');
