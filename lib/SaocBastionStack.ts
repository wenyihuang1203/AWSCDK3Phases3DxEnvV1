...
interface SaocBastionStackProps extends StackProps {
	env: Environment,
    vpc: IVpc,
...
export class SaocBastionStack extends Stack {
	constructor(scope: App, id: string, props: SaocBastionStackProps) {
...
const instanceRole = new iam.Role(this,instanceRoleName,
  ...
  //============================================//
  //=== userData and multipartUserData setup ===//
  //============================================//
    //=== regular userData ===//
  ...
  //======================================================//
	...
	const SaocBastionInstance = new ec2.Instance(this, props.InstanceName, {
		vpc: props.vpc,
   	...
   	Tags.of(SaocBastionInstance).add('Name', props.TagName);
	Tags.of(SaocBastionInstance).add('Type', props.TagType);
