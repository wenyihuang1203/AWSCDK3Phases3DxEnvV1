  ...
  constructor(scope: App, id: string, props: SaocDatabaseStackProps) {
    ...
    const SaocDBInstance = new ec2.Instance(this, props.InstanceName, {
      ...
      blockDevices: [
        ...
        {
          deviceName: '/dev/xvdb',
          volume: ec2.BlockDeviceVolume.ebs(props.volumeSize2, {
            deleteOnTermination: true,
            volumeType: props.volumeType,
          }),
        },
        {
          deviceName: '/dev/xvdc',
          volume: ec2.BlockDeviceVolume.ebs(props.volumeSize3, {
            deleteOnTermination: true,
            volumeType: props.volumeType,
          }),
        },
        {
          deviceName: '/dev/xvdd',
          volume: ec2.BlockDeviceVolume.ebs(props.volumeSize4, {
            deleteOnTermination: true,
            volumeType: props.volumeType,
          }),
        }
    ...
    Tags.of(SaocDBInstance).add('Stage', 'Build');
		Tags.of(SaocDBInstance).add('Platform', '3DExperience');
		Tags.of(SaocDBInstance).add('Service', 'DB');
