...
aws s3 cp s3://dsis-3dexp-binaries-us-east-2-201113909371/r2022x/fd02/Webapps/ /tmp/3DExplore-V6R2022x.HF2.Linux64.tar.gz
...
dos2unix /tmp/webModulesListFD2.log
while read -r line; do
    echo -e $line
    IFS='=' read -r -a array <<< $line
    echo ${array[0]}
